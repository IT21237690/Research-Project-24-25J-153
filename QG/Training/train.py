...
def main():
    ...
    # If True, attempt to load an existing trained model from TRAINED_MODEL_PATH
    FINE_TUNE_EXISTING = True

    # Paths
    TRAINED_MODEL_PATH = "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Models/custom_qg_model.pt"
    SPLIT_DATA_DIR = "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Datasets/split_datasets/"
    TRAIN_FILE = os.path.join(SPLIT_DATA_DIR, "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Datasets/split_datasets/train_dataset.json")
    VAL_FILE = os.path.join(SPLIT_DATA_DIR, "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Datasets/split_datasets/val_dataset.json")
    ...
    SAVE_PATH = "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Models/custom_qg_model_finetiuned.pt"
    MODEL_NAME = "t5-small"
    GRAPH_SAVE_DIR = "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Models/Graphs/"
    BEST_MODEL_PATH = "/home/minidu-tissera/PycharmProjects/Research-Project/v11/Models/custom_qg_model_best.pt"
    #####################################################
    ...
    train_dataset = QGDataset(TRAIN_FILE, tokenizer, max_length=64)
    val_dataset = QGDataset(VAL_FILE, tokenizer, max_length=64)
