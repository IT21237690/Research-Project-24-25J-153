...
SCORING_MODEL_PATH = "models/catboost_scoring_model.cbm"
PROSODY_MODEL_PATH = "models/prosody_contrastive_model.pth"
...
@app.post("/analyze")
async def analyze_speech(file: UploadFile = File(...), reference_text: str = Form(...)):
    try:
