...
<h2 className="text-5xl font-bold mb-3 text-pink-500">Read the Passage</h2>
    ...
    <div className="flex items-center justify-center">
      <svg className="animate-spin h-12 w-12 text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4l5-5-5-5v4a4 4 0 00-4 4z"></path>
      </svg>
      <p className="ml-4 text-lg font-semibold text-teal-500 animate-pulse">Loading Passage...</p>
    </div>
  )}
